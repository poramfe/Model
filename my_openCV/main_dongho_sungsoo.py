...
capture = cv2.VideoCapture("dataset/동호대교-성수대교1080.mov")

# Object detection from stable camera
object_detector = cv2.createBackgroundSubtractorMOG2(history=500, varThreshold=500)
...
while True:
    ...
    region_of_interest = frame[800:1000,250:750]

    # object detection on Jamsil direction area what I want
    mask = object_detector.apply(image=region_of_interest)

    _, mask = cv2.threshold(src=mask, thresh=224, maxval=255, type=cv2.THRESH_BINARY)
