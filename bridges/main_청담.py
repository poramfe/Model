...
capture = cv2.VideoCapture(filename="./bridges/dataset/청담대교/2023-10-26 13-40-13청담대교북단oneway.mov")
object_detector = cv2.createBackgroundSubtractorMOG2(history=240, varThreshold=16, detectShadows=True)
...
while True:
    ...
    # print(frame.shape)
    frame_Region_of_Interest = frame[420:700, 400:530]
    ...
    cv2.imshow(winname="ChungDam Bridge", mat=frame)
...
"""make the file"""
with open(file="bridges/measured_list/청담.txt", mode='w') as file:
