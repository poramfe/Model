...
capture = cv2.VideoCapture(filename="./bridges/dataset/천호대교/2023-10-12 13-39-07bothway.mov")
object_detector = cv2.createBackgroundSubtractorMOG2(history=360, varThreshold=16, detectShadows=False)
...
while True:
    ...
    frame_Region_of_Interest = frame[700:800, 600:1100]
