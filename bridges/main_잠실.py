...
capture = cv2.VideoCapture(filename="./bridges/dataset/잠실대교/2023-10-26 14-14-32oneway.mov")
object_detector = cv2.createBackgroundSubtractorMOG2(history=720, varThreshold=16, detectShadows=False)
