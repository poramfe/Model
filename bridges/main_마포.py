...
capture = cv2.VideoCapture(filename="./bridges/dataset/마포대교/2023-10-10 16-17-26_TUE_ZOOMoneway.mov")
object_detector = cv2.createBackgroundSubtractorMOG2(history=840, varThreshold=32, detectShadows=True)
...
while True:
    ...
    # print(frame.shape)
    frame_Region_of_Interest = frame[700:770, 720:950]
    ...
    cv2.imshow(winname="MaPo Bridge", mat=frame)
...
"""make the file"""
with open(file="bridges/measured_list/마포.txt", mode='w') as file:
