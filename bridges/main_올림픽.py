...
capture = cv2.VideoCapture(filename="./bridges/dataset/올림픽대교/2023-10-12 13-22-01oneway.mov")
...
while True:
    ...
    frame_Region_of_Interest = frame[450:520, 1300:1350]
...
"""make the file"""
with open(file="bridges/measured_list/올림픽.txt", mode='w') as file:
