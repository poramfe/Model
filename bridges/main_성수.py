...
capture = cv2.VideoCapture(filename="./bridges/dataset/성수대교/2023-10-12 12-13-43oneway.mov")
object_detector = cv2.createBackgroundSubtractorMOG2(history=1680, varThreshold=32, detectShadows=False)
...
while True:
    ...
    frame_Region_of_Interest = frame[720:820, 980:1200]
    ...
    cv2.imshow(winname="SungSoo Bridge", mat=frame)
...
"""make the file"""
with open(file="bridges/measured_list/성수.txt", mode='w') as file:
