...
capture = cv2.VideoCapture(filename="./bridges/dataset/행주대교/2023-10-10 14-59-07_TUEup.mov")
object_detector = cv2.createBackgroundSubtractorMOG2(history=150, varThreshold=16, detectShadows=True)
...
while True:
    ...
    # print(frame.shape)
    frame_Region_of_Interest = frame[620:720, 1400:1650]
    ...
    cv2.imshow(winname="HangJoo Bridge", mat=frame)
...
"""make the file"""
with open(file="bridges/measured_list/행주.txt", mode='w') as file:
