...
capture = cv2.VideoCapture(filename="./bridges/dataset/서강대교/2023-10-10 15-51-09_TUEbothway.mov")
...
while True:
    ...
    # print(frame.shape)
    frame_Region_of_Interest = frame[720:800, 1400:1770]
...
"""make the file"""
with open(file="bridges/measured_list/서강.txt", mode='w') as file:
