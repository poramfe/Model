...
capture = cv2.VideoCapture(filename="./bridges/dataset/성산대교/2023-10-24 10-57-11oneway.mov")
object_detector = cv2.createBackgroundSubtractorMOG2(history=1140, varThreshold=32, detectShadows=True)
...
while True:
    ...
    # print(frame.shape)
    frame_Region_of_Interest = frame[800:900, 1200:1450]
    ...
    cv2.imshow(winname="SungSan Bridge", mat=frame)
...
"""make the file"""
with open(file="bridges/measured_list/성산.txt", mode='w') as file:
