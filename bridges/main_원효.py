...
capture = cv2.VideoCapture(filename="./bridges/dataset/원효대교/2023-10-10 16-30-43_TUEbothway.mov")
object_detector = cv2.createBackgroundSubtractorMOG2(history=840, varThreshold=128, detectShadows=True)
...
while True:
    ...
    # print(frame.shape)
    frame_Region_of_Interest = frame[660:760, 850:1250]
    ...
    cv2.imshow(winname="WonHyo Bridge", mat=frame)
...
"""make the file"""
with open(file="bridges/measured_list/원효.txt", mode='w') as file:
